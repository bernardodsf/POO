...
namespace wfaArquivoTexto
{
    public partial class Form1 : Form
    {
        ...
        private void tbEntrada_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Enter)
            {
                ...
                else
                {
                    ...
                    MessageBox.Show(tbEntrada.Text + " não existe", "Erro de Arquivo",
                       MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            } // end if            
        ...
        {
            //C:\Users\be_ca\source\repos\wfaArquivoTexto\Teste.txt
            string caminho = tbEntrada.Text;
            //Se o arquivo não existir, é criado um novo arquivo com o texto digitado.
            using (StreamWriter arquivo = new StreamWriter(caminho, true))
            {
            arquivo.WriteLine("\n" + tbSaida.Text);
            }
            tbSaida.Clear();          
